...
module load samtools/1.11 crossmap/0.5.4
...
| bcftools norm --threads 16 -d exact --output-type z - -o ${1%.vcf.gz}.GRCh37.2.vcf.gz 
...
tabix -f -p vcf ${1%.vcf.gz}.GRCh37.2.vcf.gz
