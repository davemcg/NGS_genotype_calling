...
~/git/NGS_genotype_calling/src/create_scp_and_sbatch_jobs_for_NISC_laneBams.py -f $1 -j $2 -b $3
...
j1=$(sbatch --job-name bwa.$2 --time=12:00:00 --mem=30g --cpus-per-task 10 ~/git/NGS_genotype_calling/src/realign_NISC_laneBams_with_bwa.py $1)
############
