...
#java -Xmx64g -jar $PICARDJARPATH/picard.jar CleanSam \
#    INPUT=$1 OUTPUT=${1%.bam}.CleanSam.bam
#rm $1

# "Verify mate-pair information between mates and fix if needed."
# also coord sorts
#java -Xmx64g -jar $PICARDJARPATH/picard.jar FixMateInformation \
...
# Mark dups
#java -Xmx64g -jar $PICARDJARPATH/picard.jar MarkDuplicates \
...
# Build bam index
#java -Xmx64g -jar $PICARDJARPATH/picard.jar BuildBamIndex \
...
# Takes ~ 90 minutes
#GATK -m 64g RealignerTargetCreator \
